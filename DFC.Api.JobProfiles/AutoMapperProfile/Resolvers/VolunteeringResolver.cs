...
{
    public class VolunteeringResolver : IValueResolver<JobProfileHowToBecomeResponse, EntryRoutesApiModel, List<string>>
    {
            ...
            ResolutionContext context)
        {
            ...
            if (source != null && source.JobProfileHowToBecome.IsAny())
            {
                ...
                if (responseData.Volunteering.Html != null)
                {
                    otherRoute = dataTranslator.Translate(responseData.Volunteering.Html);
                    return otherRoute;
                }
            }
