...
namespace DFC.Api.JobProfiles.SearchServices.UnitTests
{
    public class DfcSearchQueryServiceTests
    {
        ...
        public async Task SearchAsyncTest()
        {
            ...
            var dummySharedConfigFactory = A.Fake<ISharedConfigFactory>();
            ...
            //Act
            var searchService = new DfcSearchQueryService<JobProfileIndex>(fakeIndexClient, fakeQueryConverter, fakeQueryBuilder, fakeManipulator, dummySharedConfigFactory);
        ...
        public async Task SearchActualBuilderAsyncTest(string searchTerm, string expectedComputedSearchTerm)
        {
            ...
            //Act
            var searchService = new DfcSearchQueryService<JobProfileIndex>(fakeIndexClient, fakeQueryConverter, actualQueryBuilder, actualManipulator, dummySharedConfigFactory);
            await searchService.SearchAsync(searchTerm, dummySearchProperty).ConfigureAwait(false);
